                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a class="d-flex align-items-center justify-content-center pl-2"
                                    ...
                                    <h6 class="card-title p-0">Manage Restaurants Passports</h6>
                                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropout">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="manage-restraunts-passports-view.php">
                                                    ...
                                                    <li>
                                                        <a href="manage-restraunts-passports-edit.php">
...
<script>
    $(document).ready(function () {
        $(`<button class="pointer" style="color: #3b3f5c;" data-toggle="modal" data-target="#add-passport-modal"><a class="extra-btn width-max-content">Add Passports</a></button><button><ul class="navbar-item flex-row ms-lg-auto ms-0"><li class="nav-item dropdown action-dropdown  order-lg-0 order-1"><a href="javascript:void(0);"class="nav-link dropdown-toggle user extra-btn" id="actionDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><div class="avatar-container"><div class="avatar avatar-sm avatar-indicators avatar-online"><h3>Filter</h3></div></div></a><div class="dropdown-menu position-absolute" aria-labelledby="actionDropdown"><div class="dropdown-item"><a href="#"><span>All</span></a></div><div class="dropdown-item"><a href="#"><span>Active</span></a></div><div class="dropdown-item"><a href="#"> <span>Inactive</span></a></div></div></li></ul></button>`).insertBefore("#zero-config_filter label");
    });
</script>