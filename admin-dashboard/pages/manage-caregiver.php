            ...
            <div class="middle-content container-xxl p-0">
                <div class="row layout-top-spacing ">
                    <div class="top-tabel">
                        <div class="row">
                            <div class="col-md-4">
                                <h6 class="card-title">Manage Caregiver</h6>
                            </div>
                            <div class="col-md-8">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropout">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="view-caregiver.php">
                                                            <img src="../src/assets/img/view.svg" />
                                                            <span>View Details</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="" data-toggle="modal" data-target="#caregiver-archive-modal">
                                                            <img src="../src/assets/img/archive.svg" />
                                                            <span>Archive Caregiver</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                    ...
                                                    <li>
                                                        <a href="" data-toggle="modal" data-target="#caregiver-suspend-modal">
                                                            <img src="../src/assets/img/stop.svg" />
                                                            <span>Suspend Caregiver</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
