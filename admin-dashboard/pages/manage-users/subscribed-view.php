                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-8 position-btn">
                            <h6 class="card-title">
                                ...
                                Manage Users / user / subscribed / View
                            </h6>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form style="border-right: 1px solid;">
                                                        ...
                                                        <div class="img-preview">
                                                            <p>
                                                                <label class="w-25" for="">Front Side :</label>
                                                                <img src="../src/assets/img/panfront.svg" alt="">
                                                            </p>
                                                        ...
                                                        <div class="img-preview">
                                                            <p>
                                                                <label class="w-25" for="">Back Side :</label>
                                                                <img src="../src/assets/img/panback.svg" alt="">
                                                            </p>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="img-preview">
                                                            <p>
                                                                <label class="w-25" for="">Front Side :</label>
                                                                <img src="../src/assets/img/aafront.svg" alt="">
                                                            </p>
                                                            <!-- <label class="file">Front Side :
                                                        ...
                                                        <div class="img-preview">
                                                            <p>
                                                                <label class="w-25" for="">Back Side :</label>
                                                                <img src="../src/assets/img/aaback.svg" alt="">
                                                            </p>
                                                            <!-- <label class="file">Back Side :
                                                    ...
                                                    <div class="row review">
                                                        <div class="col-md-6">
                                                            <div class='card mb-3'><label for='name'>Performance Overview:</label>
                                                                <textarea type='text' value="" placeholder="Your portfolio has generated a total return of 15% over the past six months, outperforming the S&P 500 index by 5%." readonly></textarea>
                                                            </div>
                                                            <div class='card mb-3'><label for='name'>Asset Allocation::</label>
                                                                <textarea type='text' value="" placeholder="Your portfolio is well-diversified, with 60% allocated to equities, 30% to bonds, and 10% to cash equivalents." readonly></textarea>
                                                            </div>
