                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a class="d-flex align-items-center justify-content-center pl-2"
                                    ...
                                    <h6 class="card-title p-0">Manage Restaurants Archive</h6>
                                </a>
                            </div>
                            <div class="col-md-8">
                                ...
                                <tbody class="text-center">
                                    <tr>
                                        ...
                                        <td class="view-transcation">
                                            <a class="pointer" data-toggle="modal" data-target="#restore-modal">
...
<!-- <script>
    ...
    //     $('<button><a class="extra-btn width-max-content" href="manage-restraunts-add.php">Add</a></button><button><a class="extra-btn width-max-content" href="archive-manage-customers.php">View Archive List</a></button>').insertBefore("#zero-config_filter label");
    // });
</script> -->