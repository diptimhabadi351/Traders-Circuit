 <?php $currentPage = "manage-vouchers" ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Coupon Name</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Coupon ID</label>
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
