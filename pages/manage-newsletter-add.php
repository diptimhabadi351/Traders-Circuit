                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a class="d-flex align-items-center justify-content-center pl-2" href="manage-newsletter.php">
                                    ...
                                    <h6 class="card-title p-0">Add Newsletter</h6>
                                </a>
                            </div>
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Newsletter Name :</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <div id="newsletter-quill-add" class="editor-quill" style="height: 100px;"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
<script>
    ...
    var quill = new Quill('#newsletter-quill-add', {
        theme: 'snow'
    });
</script>