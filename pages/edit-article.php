                    ...
                    <div class="top-tabel">
                        <div class="row">
                            <div class="col-md-4 left">
                                <h6 class="card-title">Edit Article Details</h6>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue non ante sit amet aliquet. Etiam vel leo sodales orci consequat porta. Aenean faucibus semper lorem</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1" class="label">Article link</label>
                                            <input type="url" name='' class="form-control" value="https://wordpress.betadelivery.com/simplitend/pages/add-article.php">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="image-preview-container">
                                                <div class="preview">
                                                    <img id="image1" src="../src/assets/img/video.png"
                                                        style="display: block;">
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="image-preview-container">
                                                <div class="preview">
                                                    <img id="image2" src="../src/assets/img/video.png"
                                                        style="display: block;">
                                                </div>
