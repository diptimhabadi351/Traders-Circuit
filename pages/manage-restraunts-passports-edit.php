                    ...
                    <div class="top-tabel">
                        <div class="row">
                            <div class="col-md-12 left d-flex align-items-center justify-content-between" style="gap: 15px;">
                                <a class="d-flex align-items-center justify-content-center pl-2" href="manage-restraunts-passports.php">
                                    <img class="back-btn" src="../src/assets/img/left-arrow.svg">
                                    <h6 class="card-title p-0">Edit Details</h6>
                                </a>
                                <a class="view-details-btn mr-2" href="manage-restraunts-passports-edit-vouchers.php">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Passport Name</label>
                                            <select class="form-control">
                                                <option value="">Cheers to Summer</option>
                                                <option value="">Cheers to Fall</option>
                                                <option value="">Cheers to Winter</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Passport ID</label>
                                            <select class="form-control">
                                                <option value="">1234234</option>
                                                <option value="">1234234</option>
                                                <option value="">1234234</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Purchased on</label>
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Expiry on</label>
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label for="company-name" class="label">Price</label>
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
